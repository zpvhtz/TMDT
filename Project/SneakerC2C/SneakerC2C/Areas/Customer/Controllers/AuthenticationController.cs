...
namespace SneakerC2C.Areas.Customer.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public string ForgotPassword(string tendangnhap, string email)
        {
            TaiKhoanBUS taikhoanbus = new TaiKhoanBUS();
        ...
        //public IActionResult ResetPassword(string tendangnhap)
        //{
        //    TaiKhoanBUS taikhoanbus = new TaiKhoanBUS();
        ...
        public async Task<IActionResult> ForgotPasswordMail(string tendangnhap)
        {
            ...
            var local = HttpContext.Request.Host;
            kichhoat += "https://" + local.ToString() + "/Customer/Authentication/ResetPassword?tendangnhap=" + tendangnhap;
            var client = new SmtpClient
            {
                Host = "smtp.gmail.com",
                Port = 587,
